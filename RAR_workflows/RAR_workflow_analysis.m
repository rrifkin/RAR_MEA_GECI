...
function RAR_workflow_analysis (input_path, include_string, exclude_string, excluded_minutes)
	...
	for i = 1:length(file_paths)
		...
		RAR_linelength (LFP_file, artifact_file, bad_channels_file, offslice_channels_file, excluded_minutes);
		RAR_findpeaks (LFP_file, artifact_file, bad_channels_file, offslice_channels_file, excluded_minutes);
	end
