...
function RAR_calcium_plot_traces(samples, amplitudes, sample_rate, channels, output_file)

	% parameters
	vertical_increment = 0.05; % vertical separation between ROIs in normalized fluorescence units
	...
	hold (ax, 'on'); 
    offset = -1 ; % is incremented to make channels appear above each other
