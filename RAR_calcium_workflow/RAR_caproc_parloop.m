...
function RAR_caproc_parloop (eleclocs_file, list_of_tifs)
...
function radius_in_pixels = find_radius (eleclocs)
	...
	pixel_difference = eleclocs(indices(2)) - eleclocs(indices(1));
	pixels_between_electrodes = pixel_difference / index_difference;
