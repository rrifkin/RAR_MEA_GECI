...
function RAR_calcium_workflow (radius, eleclocs_file, ACSF_image_directory, DMSO_image_directory, GiGA1_image_directory, DMSO_metadata_file)

	% current path (to which files will be output)
	...
	RAR_caproc_parloop (radius, eleclocs_file, ACSF_number_of_tifs, ACSF_filename_prefix, ".ome.tif", ACSF_output_filename) ; 
	...
	RAR_caproc_parloop (radius, eleclocs_file, ZMG_number_of_tifs, ZMG_filename_prefix, ".ome.tif", ZMG_output_filename) ; 
