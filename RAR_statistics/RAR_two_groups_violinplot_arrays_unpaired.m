function RAR_two_groups_violinplot_arrays_unpaired (csv_file, units)
	...
	output_file = strcat(csv_file(1:end-4), '_violinplot_n.pdf');
	saveas(fig,output_file);

	% log output to text file
	text_filename = strcat(csv_file(1:end-4), '_violinplot_n.txt');
