function RAR_two_groups_violinplot_arrays_unpaired (csv_file, units, remoutliers)
	...
	% optionally remove outliers (3 scaled median absolute deviations)
	if remoutliers == true
	...
	output_file = strcat(csv_file(1:end-4), '_violinplot.pdf');
	...
	ranksum_text = num2str(stats.ranksum);
	zval_text = num2str(stats.zval);

	description_string = strcat(test, ", W = ", ranksum_text, ", z = ", zval_text, ", n1 = ", n1, ", n2 = ", n2, ", p = ", p_t);
	fprintf(text_file,'%s\n', description_string);
