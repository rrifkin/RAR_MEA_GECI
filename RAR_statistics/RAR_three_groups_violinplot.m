function RAR_three_groups_violinplot (csv_file, units, type)
	...
	n_raw = [length(raw_data.(1)), length(raw_data.(2)), length(raw_data.(3))]
	n = [length(data.(1)), length(data.(2)), length(data.(3))]
