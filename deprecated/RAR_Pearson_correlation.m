...
function RAR_Pearson_correlation (data)
	...
	control_CI = RAR_confidence_interval(r_values_control);

	giga1_mean = mean(r_values_giga1,'omitnan');
	giga1_CI = RAR_confidence_interval(r_values_giga1);
	...
	[result,p_value] = ttest(r_values_control,r_values_giga1);
	disp(result);
	disp(p_value);
