function RAR_rapidsort_cross_correl_workflow_per_channel_all_channels(epoch)
	...
	for i = 1:numel(experiments)
		...
		DMSO_normalized_PC_bins = RAR_rapidsort_cross_correl_per_channel_all_channels (DMSO_processed_spikes_file, epoch);
		...
		GiGA1_normalized_PC_bins = RAR_rapidsort_cross_correl_per_channel_all_channels (GiGA1_processed_spikes_file, epoch);
		all_GiGA1_bins = [all_GiGA1_bins; GiGA1_normalized_PC_bins];

	end

	cd ~;
	DMSO_output_file = 'DMSO_IN-triggered_PC_bins_per_channel_all_channels.csv';
	writematrix(all_DMSO_bins, DMSO_output_file);
	GiGA1_output_file = 'GiGA1_IN-triggered_PC_bins_per_channel_all_channels.csv';
