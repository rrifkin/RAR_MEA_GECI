...
% for DMSO and GiGA1 files (intended for prevention cohort, but actually works
% for either prevention or treatment cohorts
% Input 'path' is the path to the folder for the entire slice.

function RAR_rapidsort_prevention_means (path, timepoints)
