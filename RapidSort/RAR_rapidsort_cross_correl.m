function normalized_PC_bins = RAR_rapidsort_cross_correl (processed_spikes_file, epoch, window, bin_width)
	...
	output_file = strcat(processed_spikes_file(1:end-20), '_window_', num2str(window), '_bin_width_', num2str(bin_width), '_IN-triggered_PC_bins.csv');
